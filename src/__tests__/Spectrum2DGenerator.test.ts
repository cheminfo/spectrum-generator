...
import { Spectrum2DGenerator } from '../Spectrum2DGenerator.ts';

describe('Spectrum2DGenerator', { timeout: 15000 }, () => {
  test('0 half peak', () => {
